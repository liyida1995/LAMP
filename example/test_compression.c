...
int main(int argc, char **argv)
{
    ...
    confparams_cpr->absErrBound =Errbound;
		...
		printf("Baseline compression ratio of ZFP: %lf\n",(double)dataSize*sizeof(double)/c_size_zfp);
		...
		c_size_sz=outSize;
		//Baseline sz
		printf("Baseline compression ratio of SZ: %lf\n",(double)dataSize*sizeof(double)/c_size_sz);
		...
		//LAMP zfp
		printf("LAMP compression ratio of ZFP: %lf\n",(double)dataSize*sizeof(double)/size_zfp);
    ...
    fclose(fp);
		...
		c_size_sz=outSize;
		//LAMP sz
		printf("LAMP compression ratio of SZ: %lf\n",(double)dataSize*sizeof(double)/c_size_sz);
		printf("\n");
	}
