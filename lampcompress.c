...
int main(int argc, char **argv)
{
	...
	int list[6]={1,2,6,12,13,15}; 
	char filename[50];
	sprintf(filename,"Min_datapoint_%d",list[0]);
	...
	for(int col=0;col<6;col++){
		sprintf(filename,"Min_datapoint_%d",list[col]);
		...
		c_size_zfp=zfp1_compress(data_delta,datasize,Errbound,"li");
